...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .logout(withDefaults())
                .apply(gauth
                        .loginPageUrl("/move/gauth/authorization")
                        .loginProcessingUrl("/move/login/code/gauth")
                        .successHandler(new SimpleUrlAuthenticationSuccessHandler("/gauth/login/success"))
                        .failureHandler(new SimpleUrlAuthenticationFailureHandler("/gauth/login/failure"))
                );
        return http.build();
    }
}
